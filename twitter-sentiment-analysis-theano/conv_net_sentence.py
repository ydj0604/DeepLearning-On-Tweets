...
def make_idx_data_cv(revs, word_idx_map, cv, max_l, k, filter_h):
    """
...
if __name__=="__main__":
    ...
    for i in r:
        ...
        datasets = make_idx_data_cv(revs, word_idx_map, i, max_l=max_l, k=400, filter_h=5)
        perf = train_conv_net(datasets,
                              U,
                              img_w=400,  # word emb dim
                              filter_hs=[3, 4, 5],
                              hidden_units=[100, 3],  # num filters, num classes
                              dropout_rate=[0.5],
                              shuffle_batch=True,
                              n_epochs=25,
                              batch_size=50,
